...
const ModalForm = ({ isOpen, onClose, onSubmit, title, initialData, formType = "dangVien" }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50 modal-backdrop">
      <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto modal-content shadow-2xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold animate-fade-in-up">{title}</h2>
          <button
            onClick={onClose}
            className="text-gray-500 hover:text-gray-700 hover-scale transition-transform duration-200 text-2xl"
          >
            ✕
          </button>
        </div>
